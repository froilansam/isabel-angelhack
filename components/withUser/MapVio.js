...
Geocoder.setApiKey('AIzaSyDgXQgnfRlWd25sY1LYIgQMbK3rLpr0-8Y')
  ...
  render() {
    ...
    if(this.state.location != null){ 
      ...
      <View style={{ flex: 1, alignItems: 'center' }}>
        ...
        <Text>Location: Makati City</Text>
        <TouchableOpacity 
                        style={styles.buttonContainer}
                        onPress={()=>{
                          axios.post('http://192.168.43.107:3009/mob/putvio', {
                            strLicenseNo: this.state.strLicenseNo,
                            violation: this.state.violation,
                            strTicketAdress: 'Makati City',
                          })
                          Actions.login();
                        }}>
                        <Text 
